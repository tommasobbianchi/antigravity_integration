...
exports.AgentForgeClient = void 0;
...
class AgentForgeClient {
    constructor(outputChannel) {
        ...
        const rawPluginPath = config.get('pluginPath', '../plugin.py');
    ...
    async syncSpokes(hubUrl) {
        ...
        const config = vscode.workspace.getConfiguration('agentforge');
        const configHubUrl = config.get('hubUrl');
        if (configHubUrl) {
...
exports.AgentForgeClient = AgentForgeClient;
//# sourceMappingURL=agentForgeClient.js.map